...
export default function Testimonial1() {
  ...
  const stats: StatItem[] = [
    ...
    },
    {
      ...
      decimals: 0,
      suffix: " hrs/mo",
      label: "Bursar Hours Saved",
      href: "/projects",
      cta: "See Cashless Finance",
    },
  ];
    ...
    <div className="bg-white dark:bg-black min-h-screen w-full grid place-content-center py-16 px-4 md:px-8 lg:px-16 relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center max-w-5xl mx-auto relative text-neutral-900 dark:text-white px-4 space-y-1 md:space-y-2">
          {[
            { text: "Autopilot that audits. AI that remediates.", color: "#6366f1", delay: 0 },
            { text: "School operations on true scale.", color: "#10b981", delay: 0.15 },
            { text: "23 feature modules, one platform", color: "#f59e0b", delay: 0.3 },
            { text: "and the numbers behind Ethiopian schools.", color: "#ef4444", delay: 0.45 }
          ].map((line, i) => (
