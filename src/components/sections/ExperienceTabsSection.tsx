        ...
        >
            <div className="space-y-2">
                <h2 className="text-3xl md:text-4xl font-bold text-foreground">
                    Institutional Pilots & Rollouts
                </h2>
                <p className="text-muted-foreground max-w-lg">
                    Milestones and deployments of YeneSchool across private and public Ethiopian secondary schools.
                </p>
            </div>
...
export default function ExperienceTabsSection() {
    ...
    const tabs = [
        { id: 'education' as TabType, label: 'Ministry Standards', icon: <GraduationCap className="w-4 h-4" /> },
        { id: 'journey' as TabType, label: 'Deployments', icon: <Briefcase className="w-4 h-4" /> },
        { id: 'experience' as TabType, label: 'Architecture', icon: <Rocket className="w-4 h-4" /> },
    ];
        ...
        <div className="py-16 space-y-12">
            ...
            >
                ...
                <h3 className="text-2xl font-bold text-center text-foreground capitalize">
                    {activeTab === 'education' && 'Ministry & Curriculum Standards'}
                    {activeTab === 'journey' && 'Institutional Deployments'}
                    {activeTab === 'experience' && 'Platform Architecture & Workflows'}
                </h3>
                <p className="text-center text-muted-foreground mt-2 max-w-md mx-auto">
                    {activeTab === 'education' && 'Aligned with Ethiopian Ministry of Education curriculum & national exam standards'}
                    {activeTab === 'journey' && 'A chronological history of partner school rollouts across Ethiopia'}
                    {activeTab === 'experience' && 'Detailed breakdown of high-availability microservices & offline sync architecture'}
                </p>
            </motion.div>
