...
export default function StatsSection({ scrollYProgress, showOnly }: { scrollYProgress?: any, showOnly?: 'top' | 'bottom' }) {
    ...
    useEffect(() => {
        const galleryImages = [
            { src: '/yeneschool/studentrisk.png', alt: 'Student Risk & Academic Diagnostics' },
            { src: '/yeneschool/schoolsetting.png', alt: 'Ethiopian Dual-Calendar & Settings' },
            { src: '/yeneschool/studentpromotion.png', alt: 'Ministry Promotion & Transcripts' },
            { src: '/yeneschool/syllubs.png', alt: 'National Syllabus & Timetable' },
            { src: '/yeneschool/admin.png', alt: 'Institutional Admin Command Center' },
            { src: '/yeneschool/parentdashbaord.png', alt: 'Parent Portal & Notifications' },
            { src: '/yeneschool/studentleaderboard.png', alt: 'Student Confidence Remediation' },
            { src: '/yeneschool/schooldatahealth.png', alt: 'Offline Sync & System Health' },
        ];
            ...
            {(showOnly === 'top' || !showOnly) && (
                <>
                    <div className="max-w-6xl mx-auto px-6 w-full pt-32 pb-16 text-center space-y-4">
                        ...
                        >
                            Explore the unified dashboards driving modern Ethiopian schools: AI Director cockpit, bursar cashless finance, automated ministry cards, and parent Telegram feeds.
                        </motion.p>
                    </div>
