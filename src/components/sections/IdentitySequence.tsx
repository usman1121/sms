...
export const IdentitySequence = ({ scrollYProgress, isVisible }: IdentitySequenceProps) => {
    ...
    const marqueeItems = [
        ...
        <div key="icon" className="w-32 h-32 md:w-48 md:h-48 rounded-full bg-[#60a5fa] flex items-center justify-center mx-12 shadow-[0_0_40px_rgba(96,165,250,0.5)]">
                ...
                <div className="mb-16 pointer-events-auto">
                    <MagneticEffect>
                        <div className="group flex items-center gap-2 cursor-pointer">
                            <div className="relative px-10 py-5 rounded-full bg-black dark:bg-white group-hover:bg-[#60a5fa] dark:group-hover:bg-[#60a5fa] overflow-hidden transition-all duration-500 shadow-lg group-hover:shadow-[0_0_30px_rgba(96,165,250,0.4)]">
                            ...
                            <div className="relative w-16 h-16 rounded-full bg-black dark:bg-white group-hover:bg-[#60a5fa] dark:group-hover:bg-[#60a5fa] overflow-hidden flex items-center justify-center transition-all duration-500 shadow-lg">
