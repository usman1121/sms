...
export const NavigationShortcuts = () => {
    ...
    const categories = useMemo(() => [
        {
            title: "Volume I: Autonomous OS",
            items: [
                { id: '01', title: t('home'), href: '/#hero' },
                { id: '02', title: "Documentation", href: "https://www.yeneschooldocumentation.vercel.app", external: true },
                { id: '03', title: t('contact'), href: '/contact' },
            ]
        },
        {
            title: "Volume II: Core Platform",
            items: [
                { id: '04', title: "24 Modules", href: '/projects' },
                { id: '05', title: "Institutional Pricing", href: '/#pricing' },
                { id: '06', title: "AI Director", href: '/projects/autonomous-ai-director' },
            ]
        },
        {
            title: "Volume III: Insights & Tour",
            items: [
                { id: '07', title: "Product Tour", href: '/gallery' },
                { id: '08', title: "Case Studies", href: '/blog' },
                { id: '09', title: "Telegram Channel", href: 'https://t.me/yeneschool_bot', external: true },
            ]
        }
    ], [t]);
