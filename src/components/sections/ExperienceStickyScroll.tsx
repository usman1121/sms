            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                    ...
                    <div className="p-8 relative z-10 transition-transform duration-500 group-hover:translate-x-1">
                        <div className="flex items-center gap-2 mb-4">
                            <span className="text-xs font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">Flagship Partner • Addis Ababa</span>
                        </div>
                        <h3 className="text-3xl font-black text-neutral-900 dark:text-white mb-4">Bole Medhanealem</h3>
                        <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                            Serving 1,800+ secondary students with full AI Director deployment, automated 07:00 AM administrative audits, biometric offline attendance, and automated Grade 12 remedial tracking.
                        </p>
                    </div>
                    ...
                    <div className="flex-1 flex items-center justify-center relative p-8 mt-auto border-t border-black/10 dark:border-white/10 bg-gradient-to-b from-transparent to-black/5 dark:to-white/5 overflow-hidden">
                        ...
                        <div className="absolute inset-0">
                            <Image
                                src="/yeneschool/directordashbaord.png"
                                alt="Bole Medhanealem Deployment"
                                fill
                        ...
                        <div className="relative z-10 flex flex-col items-center transition-transform duration-500 group-hover:scale-105">
                            ...
                            <div className="flex flex-wrap gap-2 justify-center mb-4">
                                {["1,800+ Students", "AI Director", "Biometric Sync"].map(s => (
                            ...
                            <p className="text-[10px] font-mono text-white/90 uppercase tracking-widest bg-black/50 px-2 py-1 rounded backdrop-blur-sm border border-white/10 group-hover:border-blue-500/50 transition-colors">Secondary School Pilot</p>
                        </div>
                ...
                >
                    ...
                    <div className="p-8 relative z-10 transition-transform duration-500">
                        <div className="flex items-center gap-2 mb-4">
                            <span className="text-xs font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">FinTech Pilot • Addis Ababa</span>
                        </div>
                        <h3 className="text-3xl font-black text-neutral-900 dark:text-white mb-4">St. Joseph School</h3>
                        <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                            Pioneered 100% cashless tuition fee reconciliation using Telebirr and CBE Birr automated webhooks, eliminating physical bank slips and manual bursar spreadsheet logs.
                        </p>
                    </div>
                    ...
                    <div className="flex-1 flex items-center justify-center relative p-8 mt-auto border-t border-black/10 dark:border-white/10 bg-gradient-to-b from-transparent to-black/5 dark:to-white/5 overflow-hidden">
                         ...
                         <div className="absolute inset-0">
                            <Image
                                src="/yeneschool/financedashbaord.png"
                                alt="St. Joseph School FinTech"
                                fill
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                            ...
                            <div className="flex flex-wrap gap-2 justify-center mb-4">
                                {["Cashless Tuition", "Telebirr & CBE", "Instant Receipt"].map(s => (
                            ...
                            <p className="text-[10px] font-mono text-white/90 uppercase tracking-widest bg-black/50 px-2 py-1 rounded backdrop-blur-sm border border-white/10 group-hover:border-orange-500/50 transition-colors">Cashless Finance Partner</p>
                        </div>
                    </div>
                </motion.div>
